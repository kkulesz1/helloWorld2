...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'kkulesz1', 'email': 'kkulesz1@terpmail.umd.edu', 'first_name': 'Kate', 'last_name': 'Kulesza',
         'password': generate_password_hash('kkulesz1', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
    ...
    students = [
        ...
        {'student_id': '2', 'first_name': 'Kate', 'last_name': 'Kulesza', 'email': 'kkulesz1@terpmail.umd.edu',
         'major_id': 4, 'birth_date': dt.datetime(2005, 3, 24), 'is_honors': 1}
    ]
